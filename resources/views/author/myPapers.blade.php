    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div class="flex items-center justify-between">
        ...
        <div class="hidden md:block">
          <a href="#" class="bg-white text-blue-600 px-6 py-3 rounded-lg font-semibold hover:bg-gray-100 transition-colors duration-200 shadow-lg">
          ...
          <div class="flex items-start justify-between">
            <div class="flex-1">
              <div class="flex items-center space-x-3 mb-2">
                <h3 class="text-xl font-bold text-gray-900">Machine Learning Approaches in Healthcare Diagnostics</h3>
              ...
              <p class="text-gray-600 mb-4 line-clamp-2">
                This paper presents novel machine learning approaches for improving diagnostic accuracy in healthcare systems. 
                Our methodology demonstrates significant improvements in early disease detection...
              </p>
